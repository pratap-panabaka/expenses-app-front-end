const Home = () => {
    return (
        <div className="center-div min-height bg-lite flex flex-col gap-5 p-5">
            <h1 className="font-bold text-4xl text-black">Welcome to the Expenses & Contacts App</h1>
            <p className="max-w-xl font-bold border-2 text-white border-dark bg-dark p-5">
